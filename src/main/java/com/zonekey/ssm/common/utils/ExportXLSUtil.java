...
public class ExportXLSUtil 
{
    ...
    * @param amounts 是否为金额
    */
	public static HSSFWorkbook exportExcel(String title, String[] headers, List<List<Object>> dataset, Boolean[] amounts) 
	{
	 ...
	 * @param moneyStyle
	 */
	private static void fillData(HSSFSheet sheet,List<List<Object>> dataset,int fIndex,int lIndex,Boolean[] amounts,HSSFCellStyle dataStyle,HSSFCellStyle moneyStyle)
	{
		HSSFRow row=null;
		int rowNum=0;
		...
		{	
			...
			Object[] fields=dataset.get(i).toArray();
