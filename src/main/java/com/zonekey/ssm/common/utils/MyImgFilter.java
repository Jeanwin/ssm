...
public class MyImgFilter {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream fin = new FileInputStream(new File("C:\\Users\\admin\\Desktop\\新建文件夹 (2)\\1765755-1680x1050.jpg"));
		...
		String pname = "c:\\123.jpg".substring(0, "123.jpg".lastIndexOf("."));
