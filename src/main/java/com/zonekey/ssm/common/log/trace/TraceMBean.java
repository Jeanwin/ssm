package com.zonekey.ssm.common.log.trace;
...
public class TraceMBean {
	 ...
	 * TraceMbean的注册名称.
	 */
	public static final String TRACE_MBEAN_NAME = "disrec:name=trace,type=Trace";

	private String traceLoggerName = "com.zonekey.disrec";
